...
> 正所谓前人栽树，后人乘凉，本篇转自[BY Blog](http://qiubaiying.top)。
> 
...
keyword: "Blog, 昊天的博客, haotian, 昊天" #关键词
url: "https://haotianblog.github.io"          # 这个就是填写你的博客地址
baseurl: ""      # 这个我们不用填写
...
sidebar-avatar:/img/haotian.JPG      # 你的个人头像 这里你可以改成我在img文件夹中的两张备用照片 img/avatar-m 或 avatar-g
```
#### 社交账号
展示你的其他社交平台
